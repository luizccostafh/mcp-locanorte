...
> **Atualizado em 2026-06-16** para refletir o código realmente no ar (`server.py` v1.5.0).
...
Claude → Settings → Connectors → conector "MCP Locanorte"
        ▼
Tools: status_locanorte, resumo_locanorte, fluxo_caixa (dados reais)
```
...
## 3. server.py atual (v1.5.0 — no ar)
