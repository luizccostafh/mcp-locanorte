...
- Arquivo principal: `server.py` (contrato **v1.11.0**)
...
## TOOLS ATUAIS (v1.11.0 — dados reais, retornam dict/JSON) — 7 tools
...
- `fluxo_caixa()` → **(v1.5.0)** caixa hoje (último saldo por conta, com `data_saldo_base`),
...
4. ⚠️ **Sync do Kondado**: tabelas operacionais com `last_updated` em 2026-05-26 (cadência/parada do
   ...
   Atenção: `caixa_hoje.data_saldo_base` já voltou com data futura — investigar a lógica de saldo diário.
